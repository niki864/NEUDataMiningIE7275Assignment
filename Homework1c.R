...
boxplot(dataset$C)
boxplot(dataset$D)
boxplot(dataset2$standardize.dataset.A.)
boxplot(dataset2$standardize.dataset.B.)
boxplot(dataset2$standardize.dataset.C.)
boxplot(dataset2$standardize.dataset.D.)
